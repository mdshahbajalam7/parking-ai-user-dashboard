...
export default function Postshoutout() {
  ...
  useEffect(() => {
    dispatch(
      fetchPostsByType({ type: "shoutout", page: page + 1, limit: rowsPerPage })
    );
  }, [page, rowsPerPage]);
  ...
  const getPromotionChipColor = (type) => {
    const colors = {
      0: { color: "default", label: "Standard" },
      1: { color: "info", label: "Boosted" },
      2: { color: "secondary", label: "Premium" },
      3: { color: "primary", label: "Featured" },
    };
          ...
          <Stack direction="row" alignItems="center" spacing={2}>
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                Manage promotional shoutouts and announcements
              </Typography>
            </Box>
          </Stack>
        </Box>
        ...
        <TableContainer>
          <Table sx={{ minWidth: 650 }}>
            <TableHead>
              ...
              >
                <TableCell sx={{ py: 2, pl: 3 }}>Shoutout Details</TableCell>
                <TableCell sx={{ py: 2 }}>Message</TableCell>
                <TableCell sx={{ py: 2 }}>Promotion Level</TableCell>
                    ...
                    <Fade in={true} timeout={300 + index * 100} key={post._id}>
                      ...
                      >
                        ...
                        <TableCell sx={{ py: 2, maxWidth: 200 }}>
                          ...
                          >
                            {post.description || "No message available"}
                          </Typography>
                        </TableCell>
                        ...
                        <TableCell align="center" sx={{ py: 2, pr: 3 }}>
                          <Stack
                            ...
                            justifyContent="center"
                          >
                            <Tooltip title="Edit Shoutout" arrow>
                              <IconButton
                            ...
                            <Tooltip title="Delete Shoutout" arrow>
                              <IconButton
