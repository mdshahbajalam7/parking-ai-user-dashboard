...
export default function Postrequest() {
  ...
  useEffect(() => {
    dispatch(
      fetchPostsByType({ type: "request", page: page + 1, limit: rowsPerPage })
    );
  }, [page, rowsPerPage]);
  ...
  const getPromotionChipColor = (type) => {
    const colors = {
      0: { color: "default", label: "Normal" },
      1: { color: "info", label: "Urgent" },
      2: { color: "warning", label: "Priority" },
      3: { color: "error", label: "Critical" },
    };
  ...
  return (
    <Box
      p={2}
      sx={{
        background: `linear-gradient(135deg, ${alpha(theme.palette.info.main, 0.02)} 0%, ${alpha(theme.palette.success.main, 0.02)} 100%)`,
        minHeight: "100vh",
      }}
    >
      <Paper
      ...
      >
        ...
        >
          <Stack direction="row" alignItems="center" spacing={2}>
            ...
            >
              <MdQuestionAnswer size={24} color="white" />
            </Box>
            <Box>
              <Typography
                variant="h5"
              ...
              <Typography variant="body2" color="text.secondary">
                Handle user requests and service inquiries
              </Typography>
            </Box>
          </Stack>
        </Box>
        ...
        <TableContainer>
          <Table sx={{ minWidth: 650 }}>
            <TableHead>
              <TableRow
                sx={{
                  background: `linear-gradient(90deg, ${alpha(theme.palette.info.main, 0.05)} 0%, ${alpha(theme.palette.success.main, 0.05)} 100%)`,
                  "& th": {
                    fontWeight: 600,
                    fontSize: "0.875rem",
              ...
              >
                <TableCell sx={{ py: 2, pl: 3 }}>Request Details</TableCell>
                <TableCell sx={{ py: 2 }}>Requirements</TableCell>
                <TableCell sx={{ py: 2 }}>Priority Level</TableCell>
                    ...
                    <Fade in={true} timeout={300 + index * 100} key={post._id}>
                      ...
                      >
                        ...
                        <TableCell sx={{ py: 2, maxWidth: 200 }}>
                          ...
                          >
                            {post.description || "No requirements specified"}
                          </Typography>
                        </TableCell>
